...
namespace Dolittle.TimeSeries.Runtime.Connectors
{
    ...
    public class MissingConnectorIdentifierOnRequestHeader : Exception
    {
        ...
        /// </summary>
        public MissingConnectorIdentifierOnRequestHeader() : base("The request header requires the 'pushconnectorid' to be set to a valid GUID representing the connector") {}
    }
}