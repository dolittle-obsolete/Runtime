...
namespace Dolittle.TimeSeries.Runtime.Identity
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of <see cref="NoTimeSeriesIdentifierCanIdentify"/>
        /// </summary>
        /// <param name="source">The <see cref="Source"/></param>
        /// <param name="tag">The <see cref="Tag"/></param>
        public NoTimeSeriesIdentifierCanIdentify(Source source, Tag tag) : base($"No TimeSeries identifier can identify a tag named '{tag}' from source '{source}'") {}
